"""Captures Policy 3's deterministic Isaac Lab rollout (obs + action + absolute
arm joint positions, 33-dim obs -- see run_policy3.py's docstring for why it's
33 not 39) to an .npz file, for comparison against run_policy3.py's MuJoCo
rollout via compare_trajectories.py.
"""
import argparse
...
parser.add_argument("--out", type=str,
                     default="/home/virtual-acc/projects/g1_lift_ext/mujoco_transfer/trajectory_isaac_policy3.npz")
