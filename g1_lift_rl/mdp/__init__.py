...
from .rewards import (
    reward_reach,
    reward_object_lifted,
    reward_goal_tracking_coarse,
    reward_goal_tracking_fine,
    reward_object_lifted_ungated,
    reward_goal_tracking_coarse_ungated,
    reward_goal_tracking_fine_ungated,
    reward_hover,
    reward_descend,
    ...
    penalty_cube_drift_after_release,
